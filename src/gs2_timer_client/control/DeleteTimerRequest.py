...
class DeleteTimerRequest(Gs2BasicRequest):
    ...
    def __init__(self, params=None):
        ...
        """
        super(DeleteTimerRequest, self).__init__(params)
        if params is None:
    ...
    def set_timer_id(self, timer_id):
        ...
        """
        if timer_id and not (isinstance(timer_id, str) or isinstance(timer_id, unicode)):
